package Lab4_Inheritence;//inheritance...
...
class Point3D extends Point{ //extended version of class Point
    double z;
    ...
    //(Class Point's) methode overriding (extending for p2)
    void printPoint() {
        System.out.println("(" + x + " , " + y + " , " + z + ")"); //add the change
    }
}

public class labClassFour_Inheritance_superSub_Class {
    public static void main(String[] args)
    {
        ...
        Point p2 = new Point3D(50,60,70); //don't need to call another (Point3D) class.
        p2.printPoint();
